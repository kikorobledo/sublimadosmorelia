<div>
    @if ($paginator->hasPages())
        ...
        <nav role="navigation" aria-label="Pagination Navigation" class="flex items-center justify-between" x-data>
            <div class="flex justify-between flex-1 sm:hidden" @click=" window.scrollTo({
                top: 0,
                behavior: 'smooth'
            });">
                <span>
            ...
            <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                ...
                <div>
                    <span class="relative z-0 inline-flex rounded-md shadow-sm" @click=" window.scrollTo({
                        top: 0,
                        behavior: 'smooth'
                    });">
                        <span >
