<div class="">
    ...
    <div class="mb-5">
        ...
        <h1 class="titulo-seccion text-3xl font-thin text-gray-500 mb-3">Videos</h1>
        ...
        <div class="flex justify-between">
            ...
            <button wire:click="openModalCreate" class="bg-gray-500 hover:shadow-lg hover:bg-gray-700 float-right mb-5 text-sm py-2 px-4 text-white rounded-full focus:outline-none hidden md:block">Agregar nuevo Video</button>
            ...
            <table class="rounded-lg w-full">
                ...
                <thead class="border-b border-gray-300 bg-gray-50">
                    ...
                    <tr class="text-xs font-medium text-gray-500 uppercase text-left traling-wider">
                        ...
                        <th wire:click="order('url')" class="cursor-pointer px-3 py-3 hidden lg:table-cell">
                    ...
                    @foreach($videos as $video)
                        ...
                        <tr class="text-sm font-medium text-gray-500 bg-white flex lg:table-row flex-row lg:flex-row flex-wrap lg:flex-no-wrap mb-10 lg:mb-0">
                            ...
                            <td class="px-3 py-3 w-full lg:w-auto p-3 text-gray-800 text-center lg:text-left lg:border-0 border border-b block lg:table-cell relative lg:static">
                                ...
                                <span class="lg:hidden absolute top-0 left-0 bg-blue-300 px-2 py-1 text-xs text-white font-bold uppercase rounded-br-xl">URL</span>

                                <a href="{{ $video->url }}" target="_blank" class="text-sm font-medium text-white bg-blue-700 px-3 py-1 rounded-full">Link</a>
                            ...
                            <td class="px-3 py-3 w-full lg:w-auto p-3 text-gray-800 text-center lg:text-left lg:border-0 border border-b block lg:table-cell relative lg:static">
                                ...
                                @if($video->created_by != null)

                                    <span class="font-semibold">Registrado por: {{$video->createdBy->name}}</span> <br>
                            ...
                            <td class="px-3 py-3 w-full lg:w-auto p-3 text-gray-800 text-center lg:text-left lg:border-0 border border-b block lg:table-cell relative lg:static">
                                ...
                                @if($video->updated_by != null)

                                    <span class="font-semibold">Actualizado por: {{$video->updatedBy->name}}</span> <br>
                            ...
                            <td class="px-3 py-3 w-full lg:w-auto p-3 text-gray-800 text-center lg:text-left lg:border-0 border border-b lg:table-cell relative lg:static">
                                ...
                                <div class="flex justify-center lg:justify-start">
                                    ...
                                    <button
                                        wire:click="openModalEdit({{$video}})"
                                        wire:loading.attr="disabled"
                                        wire:target="openModalEdit({{$video}})"
                                    ...
                                    <button
                                        wire:click="openModalDelete({{$video}})"
                                        wire:loading.attr="disabled"
                                        wire:target="openModalDelete({{$video}})"
            ...
            <div class="flex flex-col md:flex-row justify-between md:space-x-3 mb-5">
                ...
                <div class="flex-auto ">
                    ...
                    <div>
                        ...
                        <input type="text" class="bg-white rounded text-sm w-full" wire:model.defer="url">

                    </div>

                    <div>

                        @error('url') <span class="error text-sm text-red-500">{{ $message }}</span> @enderror
    ...
    <x-jet-confirmation-modal wire:model="modalDelete">
        ...
        <x-slot name="content">
            ¿Esta seguro que desea eliminar el video? No sera posible recuperar la información.
        </x-slot>
