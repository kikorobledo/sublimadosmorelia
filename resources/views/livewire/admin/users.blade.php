            ...
            <table class="rounded-lg w-full">
                ...
                <thead class="border-b border-gray-300 bg-gray-50">
                    ...
                    <tr class="text-xs font-medium text-gray-500 uppercase text-left traling-wider">
                        ...
                        <th wire:click="order('cellphone')" class="cursor-pointer px-3 py-3 hidden lg:table-cell">
                        ...
                        <th wire:click="order('Facebook')" class="cursor-pointer px-3 py-3 hidden lg:table-cell">
                    ...
                    @foreach($users as $user)
                        ...
                        <tr class="text-sm font-medium text-gray-500 bg-white flex lg:table-row flex-row lg:flex-row flex-wrap lg:flex-no-wrap mb-10 lg:mb-0">
                            ...
                            <td class="px-3 py-3 w-full lg:w-auto p-3 text-gray-800 text-center  lg:border-0 border border-b block lg:table-cell relative lg:static">
                                ...
                                <span class="lg:hidden absolute top-0 left-0 bg-blue-300 px-2 py-1 text-xs text-white font-bold uppercase rounded-br-xl">Facebook</span>
                            ...
                            <td class="px-3 py-3 w-full lg:w-auto capitalize p-3 text-gray-800 text-center lg:text-left lg:border-0 border border-b block lg:table-cell relative lg:static">
                                ...
                                <span class="lg:hidden absolute cap top-0 left-0 bg-blue-300 px-2 py-1 text-xs text-white font-bold uppercase rounded-br-xl">Role</span>
            ...
            <div class="flex flex-col md:flex-row justify-between md:space-x-3 mb-5">
                ...
                <div class="flex-auto ">
                    ...
                    <div>
                        ...
                        <input type="text" class="bg-white rounded text-sm w-full" wire:model.defer="cellphone">

                    </div>

                    <div>

                        @error('cellphone') <span class="error text-sm text-red-500">{{ $message }}</span> @enderror
            ...
            <div class="flex flex-col md:flex-row justify-between md:space-x-3 mb-5">
                ...
                <div class="flex-auto ">
                    ...
                    <div>
                        ...
                        <input type="text" class="bg-white rounded text-sm w-full" wire:model.defer="facebook">

                    </div>

                    <div>

                        @error('facebook') <span class="error text-sm text-red-500">{{ $message }}</span> @enderror
