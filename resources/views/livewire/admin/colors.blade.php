<div class="">
    ...
    <div class="mb-5">
        ...
        <h1 class="titulo-seccion text-3xl font-thin text-gray-500 mb-3">Colores</h1>

        <div>

            <input type="text" wire:model="search" placeholder="Buscar" class="bg-white rounded-full text-sm">

                <button wire:click="openModalCreate" class="bg-gray-500 hover:shadow-lg hover:bg-gray-700 float-right mb-5 text-sm py-2 px-4 text-white rounded-full focus:outline-none hidden md:block">Agregar nuevo Color</button>
                    ...
                    @foreach($colors as $color)
                        ...
                        <tr class="text-sm font-medium text-gray-500 bg-white flex lg:table-row flex-row lg:flex-row flex-wrap lg:flex-no-wrap mb-10 lg:mb-0">
                            ...
                            <td class="px-3 py-3 w-full lg:w-auto p-3 text-gray-800 text-center lg:text-left lg:border-0 border border-b block lg:table-cell relative lg:static">
                                ...
                                @if($color->created_by != null)

                                    <span class="font-semibold">Registrado por: {{$color->createdBy->name}}</span> <br>
                            ...
                            <td class="px-3 py-3 w-full lg:w-auto p-3 text-gray-800 text-center lg:text-left lg:border-0 border border-b block lg:table-cell relative lg:static">
                                ...
                                @if($color->updated_by != null)

                                    <span class="font-semibold">Actualizado por: {{$color->updatedBy->name}}</span> <br>
                            ...
                            <td class="px-3 py-3 w-full lg:w-auto p-3 text-gray-800 text-center lg:text-left lg:border-0 border border-b lg:table-cell relative lg:static">
                                ...
                                <div class="flex justify-center lg:justify-start">
                                    ...
                                    <button
                                        wire:click="openModalEdit({{$color}})"
                                        wire:loading.attr="disabled"
                                        wire:target="openModalEdit({{$color}})"
                                    ...
                                    <button
                                        wire:click="openModalDelete({{$color}})"
                                        wire:loading.attr="disabled"
                                        wire:target="openModalDelete({{$color}})"
    ...
    <x-jet-confirmation-modal wire:model="modalDelete">
        ...
        <x-slot name="content">
            ¿Esta seguro que desea eliminar al color?, No sera posible recuperar la información.
        </x-slot>
