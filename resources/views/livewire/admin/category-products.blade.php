<div class="">
    ...
    <div class="mb-5">
        ...
        <h1 class="titulo-seccion text-3xl font-thin text-gray-500 mb-3">Categorías de productos</h1>
                            ...
                            <td class="px-3 py-3 w-full lg:w-auto p-3 text-gray-800 text-center lg:text-left lg:border-0 border border-b lg:table-cell relative lg:static">
                                ...
                                <div class="flex justify-center lg:justify-start">
                                    ...
                                    <button
                                        ...
                                        wire:target="openModalEdit({{$category}})"
                                    ...
                                    <button
                                        wire:click="openModalDelete({{$category}})"
                                        wire:loading.attr="disabled"
                                        wire:target="openModalDelete({{$category}})"
